...
export const MEDIUM_SCREEN_WIDTH = 1163;
export const SMALL_SCREEN_WIDTH = 672;

export const INITIAL_LARGE_SCREEN_CARDS = 12;
export const INITIAL_MEDIUM_SCREEN_CARDS = 8;
export const INITIAL_SMALL_SCREEN_CARDS = 5;
